...
namespace BunnyHopMonogame.Src.Entities.Enemy {
    ...
    public class EnemyHelicopterGun : Enemy {

        public Sprite sp;
        public EnemyBehaviour enemyBehaviour;

        public EnemyHelicopterGun(int x, int y, EnemyBehaviour enemyBehaviour, int range, bool goingLeft) {
            this.enemyBehaviour = enemyBehaviour;
            health = 2;
            sp = new Sprite("enemy_helicopter_gun", 4, 0.3f);
